...
let cloudSaveTimerId = null;
  ...
  function resetMinisterialAudioButton() {
    const audioButton =
      document.querySelector(
        "#ministerialQuestionAudioButton"
      );
  ...
  function toggleMinisterialQuestionAudio() {
    ...
    const started =
      speakText(
        currentQuestion.question,
        {
          ...
          onError: (error) => {
            console.error(
              "Ministerial question audio error:",
              error
            );
...
function saveRecentMinisterialQuestions(
  questionIds
) {
  ...
  try {
    ...
    console.error(
      "Impossibile salvare le domande recenti:",
      error
    );
  }
}
...
<div class="ministerial-question-audio-row">
  <button
    id="ministerialQuestionAudioButton"
    class="
      question-audio-button
      ministerial-question-audio-button
    "
    type="button"
...
if (flagButton) {
  flagButton.addEventListener(
    ...
    document
      ...
      ?.addEventListener(
        "click",
        toggleMinisterialQuestionAudio
      );
    document
      .querySelector(
...
function finishExam(reason) {
  ...
  saveRecentMinisterialQuestions(
    questionIds
  );
