...
async function resolveLessonAccessLevel(
  subtopicId
) {
  const access =
...
export async function createTheoryLesson(
  ...
  payload.accessLevel =
    await resolveLessonAccessLevel(
      payload.subtopicId
    );
